      ...
      if (isHotspot && !deviceSettings.standAloneEnable) {
        ...
        switch (deviceSettings.portApixConfig) {
          case WS2812_RGB_800KHZ:
            jsonReply["portApixConfig"] = "WS2812 RGB 800Khz";
            break;

          case WS2812_RGB_400KHZ:
            jsonReply["portApixConfig"] = "WS2812 RGB 400Khz";
            break;

          case WS2812_RGBW_800KHZ:
            jsonReply["portApixConfig"] = "WS2812 RGBW 800Khz";
            break;

          case WS2812_RGBW_400KHZ:
            jsonReply["portApixConfig"] = "WS2812 RGBW 400Khz";
            break;

          case APA102_RGBB_800KHZ:
            jsonReply["portApixConfig"] = "APA102 RGBB 800Khz";
            break;

          case APA102_RGBB_400KHZ:
            jsonReply["portApixConfig"] = "APA102 RGBB 400Khz";
            break;
        }
        switch (deviceSettings.portBpixConfig) {
          case WS2812_RGB_800KHZ:
            jsonReply["portBpixConfig"] = "WS2812 RGB 800Khz";
            break;

          case WS2812_RGB_400KHZ:
            jsonReply["portBpixConfig"] = "WS2812 RGB 400Khz";
            break;

          case WS2812_RGBW_800KHZ:
            jsonReply["portBpixConfig"] = "WS2812 RGBW 800Khz";
            break;

          case WS2812_RGBW_400KHZ:
            jsonReply["portBpixConfig"] = "WS2812 RGBW 400Khz";
            break;

          case APA102_RGBB_800KHZ:
            jsonReply["portBpixConfig"] = "APA102 RGBB 800Khz";
            break;

          case APA102_RGBB_400KHZ:
            jsonReply["portBpixConfig"] = "APA102 RGBB 400Khz";
            break;
        }
      }
...
static void wifiStart() {
  ...
  if (deviceSettings.ethernetEnable) {
    ...
    while (!ETH.linkUp() && endTime > millis()) {
      yield();
    }
