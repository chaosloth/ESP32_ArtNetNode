    ...
    case 1:     // Device Status
      ...
      if (isHotspot && !deviceSettings.standAloneEnable) {
        ...
        switch (deviceSettings.portApixConfig) {
          ...
          case WS2812_RGBW_800KHZ_SPECIAL:
            jsonReply["portApixConfig"] = "WS2812 RGBW 800Khz Special";
            break;
        ...
        switch (deviceSettings.portBpixConfig) {
          ...
          case WS2812_RGBW_800KHZ_SPECIAL:
            jsonReply["portBpixConfig"] = "WS2812 RGBW 800Khz Special";
            break;
